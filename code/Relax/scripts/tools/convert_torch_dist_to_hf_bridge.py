...
# Transformers builds this mapping at import time by scanning every installed
# distribution's RECORD file. That scan can take indefinitely on FUSE-backed
# environments, while the converter only needs versions for a small set of
# runtime dependencies.
_FAST_PACKAGE_DISTRIBUTION_MAPPING = {
...
importlib.metadata.packages_distributions = lambda: _FAST_PACKAGE_DISTRIBUTION_MAPPING
