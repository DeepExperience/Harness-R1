...
class CheckpointEngineClient:
    ...
    async def start(self) -> None:
        ...
        # Start heartbeat. RL steps with environment reruns can take minutes;
        # without heartbeats the coordinator drops healthy actor/rollout nodes
        # before the next weight sync.
        self._running = True
