...
_SERVE_RUN_LOCK = threading.Lock()
...
class Service:
    ...
    def _deploy(self, pgs: Optional[Any] = None) -> None:
        ...
        # Ray Serve client startup is not reliably re-entrant when several
        # services call serve.run from different threads during boot.
        with _SERVE_RUN_LOCK:
